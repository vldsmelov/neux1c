...
urlpatterns = [
    ...
    path("planning/drivers/", drivers_index, name="drivers_index"),
    ...
    path("reports/consolidation/", consolidation_report, name="consolidation_report"),
    path("reports/drill/", plan_fact_drilldown, name="plan_fact_drilldown"),
    ...
    path("api/v1/funding-cases/<int:case_id>/", api_funding_case_detail, name="api_funding_case_detail"),
    path("api/v1/payment-facts/", api_payment_facts, name="api_payment_facts"),
    path("api/v1/exchange-rates/", api_exchange_rates, name="api_exchange_rates"),
